...
function App() {
	...
	return (
    	<div className="flex flex-col  overflow-x-hidden ">
			<div className="fixed bottom-0 left-5 text-gray-300 md:flex flex-col justify-center items-center  hidden show-footer z-10">
				{mapImages}
				<div className="border-l border-gray-300 h-32 mt-10" />
			</div>
			<div className="fixed bottom-0 right-6 text-gray-300 md:flex flex-col justify-center items-center w-5 hidden show-footer z-10">
