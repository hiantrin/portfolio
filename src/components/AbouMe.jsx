    ...
    <div id="About" ref={myRef}  className={!myElement ? "opacity-0 " : 'flex flex-col w-full py-28  px-10 sm:pl-[8%]  xl:pl-[15%] 2xl:pl-[20%] space-y-6 reveal '}>
        ...
        <div className='flex  w-auto flex-col md:flex-row space-y-28 md:space-y-0'>
			<div className='flex flex-col w-full  md:w-[50%] lg:w-[480px] mr-20 lg:mr-10 space-y-5'>
				<h1 className='text-gray-500 text-xs xs:text-sm sm:text-lg'>Hello! My name is Hamza and I enjoy creating things that live on the internet. My interest in web development started back in 2019 When i decided to enter 1337 programmation school turns out that am so good at programmation especially in developement web.</h1>
				<h1 className='text-gray-500 text-xs xs:text-sm sm:text-lg'>Now after 3years of 1337 cursus i become a full stack developer having specialization in back end and front end development. </h1>
				...
				<h1 className='text-gray-500 text-xs xs:text-sm sm:text-lg'>Also i have 6 months experience in my internship in DROPLEET between May 2021 - October 2021</h1>
				<h1 className='text-gray-500 text-xs xs:text-sm sm:text-lg'>Here are technologies am working with currently:</h1>
				{mapSkills}
			</div>
