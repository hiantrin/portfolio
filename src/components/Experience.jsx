    ...
    return (
        <div id="Experience" ref={myRef}  className={!myElement ? "opacity-0 mt-20" : 'flex flex-col w-full my-20  px-10 sm:pl-[8%]  lg:pl-[20%] 2xl:pl-[25%] space-y-6 reveal mt-40'}>
            <div className='flex  items-center mb-10 space-x-7'>
                <h1 className='text-2xl text-green-300 text-mono font-mono '>02. <span className='text-gray-300 text-3xl  font-bold'>Where I've Worked</span></h1>
            ...
            <div className='flex space-x-6'>
                <div className='flex items-center space-x-3 pr-3 bg-gray-800 h-10'>
                    <div className='h-10 w-[2px] rounded-lg bg-green-300'/>
                    <h1 className='text-sm text-green-300 font-mono'>DROPLEET</h1>
                </div>
                <div className='flex flex-col'>
                    <h1 className='text-gray-300 whitespace-pre text-lg font-mono mt-[5px]'>Engineer <span className='text-green-300 font-mono text-lg'>@ DROPLEET</span></h1>
                    <h1 className='text-sm font-mon text-gray-400 mt-2'>May 2021 - Present</h1>
                    <div className='flex space-x-3 mt-8  w-[480px]'>
                        <FontAwesomeIcon icon={faCaretRight} className="text-green-300 mt-1"/>
